...
import 'blocs/topic_detail_bloc.dart';
import 'blocs/topic_detail_state.dart';
import 'components/schedule_selection_one_with_id_page.dart';
import '../../../../components/user_selection_multi_with_code_page.dart';
import '../topic_list/components/topic_list_view.dart';
...
class _TopicDetailPageState extends State<TopicDetailPage> with BasePageState {
  ...
  void _handleListeners(BuildContext context, TopicDetailState state) {
    if (state is TopicUpdatedState) {
  ...
  Widget build(BuildContext context) {
    return BlocListener<TopicDetailBloc, TopicDetailState>(
