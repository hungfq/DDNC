...
import 'package:ddnc_new/ui/pages/admin/user/user_list/blocs/user_list_state.dart';
...
class UserSearchField extends StatefulWidget with PreferredSizeWidget {
...
class _UserSearchFieldState extends State<UserSearchField> {
  ...
  late UserListBloc _topicListBloc;
  ...
  @override
  void initState() {
    _topicListBloc = context.read<UserListBloc>();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<UserListBloc, UserListState>(
      listener: (_, state) {
        if (state is UserListDataChangedState &&
            state.event == UserListDataChangedEvent.keywordChanged) {
