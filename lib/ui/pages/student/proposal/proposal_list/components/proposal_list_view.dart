...
class TopicProposalListView extends StatefulWidget {
  const TopicProposalListView({Key? key}) : super(key: key);

  static const String topic = "topic_key";
  static const String topicAction = "EDIT";

  @override
  State<TopicProposalListView> createState() => _TopicProposalListViewState();
}

class _TopicProposalListViewState extends State<TopicProposalListView> {
  ...
  Widget build(BuildContext context) {
    return MediaQuery.removePadding(
      ...
      child: Scrollbar(
        ...
        child: BlocConsumer<TopicProposalListBloc, TopicProposalListState>(
          listener: _handleListeners,
          buildWhen: (_, state) => [
            TopicProposalListFetchedState,
            TopicProposalListLoadMoreState,
            TopicProposalListRefreshedState
          ].contains(state.runtimeType),
          builder: (context, state) {
            var resource = _topicListBloc.getListTopicProposalResult;
  ...
  void _handleListeners(BuildContext context, TopicProposalListState state) {
    if (state is TopicProposalListFetchedState) {
      ...
      switch (resource.state) {
        ...
        case Result.success:
          ...
          var userList = _topicListBloc.getListTopicProposalResult.data?.data ?? [];
          if (userList.isEmpty) {
    ...
    if (state is TopicProposalListRefreshedState) {
      var resource = state.resource;
    ...
    if (state is TopicProposalListLoadMoreState) {
      var resource = state.resource;
      switch (resource.state) {
        case Result.loading:
          ...
          child: InkWell(
            ...
            onTap: () {
              NavigationService.instance
                ...
                TopicProposalListView.topic: topic,
                TopicProposalListView.topicAction: "EDIT",
              });
            },
          ),
        ));
