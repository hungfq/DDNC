...
import '../components/topic_show.dart';
import 'package:ddnc_new/ui/resources/dimens.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

class LecturerTopicListView extends StatefulWidget {
  const LecturerTopicListView({Key? key}) : super(key: key);

  static const String topic = "topic_key";

  @override
  State<LecturerTopicListView> createState() => _LecturerTopicListViewState();
}

class _LecturerTopicListViewState extends State<LecturerTopicListView> {
  ...
  Widget build(BuildContext context) {
    return MediaQuery.removePadding(
      ...
      child: Scrollbar(
        ...
        child: BlocConsumer<LecturerTopicListBloc, LecturerTopicListState>(
          listener: _handleListeners,
          buildWhen: (_, state) => [
            LecturerTopicListFetchedState,
            LecturerTopicListLoadMoreState,
            LecturerTopicListRefreshedState
  ...
  void _handleListeners(BuildContext context, LecturerTopicListState state) {
    ...
    if (state is LecturerTopicListRefreshedState) {
      var resource = state.resource;
    ...
    if (state is LecturerTopicListLoadMoreState) {
      var resource = state.resource;
      switch (resource.state) {
        case Result.loading:
